...
- 固件目录：`esp32/ANT_BMS_TFT_Dashboard_V2_4_3_TftBuildConfig/`
- 小程序目录：`miniprogram/`
- 固件版本：`ANT_BMS_TFT_Dashboard_V2_4_3_TftBuildConfig`
- 屏幕驱动：TFT_eSPI
- 屏幕方向：横屏 320x170

旧的 V2.2、V2.4、V2.4.1 和 V2.4.2 目录仍保留用于追溯，不作为当前客户版首选。
...
```powershell
arduino-cli compile --fqbn esp32:esp32:esp32:PartitionScheme=huge_app esp32/ANT_BMS_TFT_Dashboard_V2_4_3_TftBuildConfig
```
